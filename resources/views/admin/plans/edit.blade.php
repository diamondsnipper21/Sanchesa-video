...
@section('content')
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            {!! Form::open(['id' => 'form-plan', 'route' => ['admin.plans.update', $plan], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                        ...
                        @foreach($plan->tags as $tag)
                            <span class="badge">{{ $tag->slug }} <a method="DELETE" data-confirm="Are you sure to untag {{ $tag->slug }}?" href="{{ route('admin.plans.untag', [$plan->id, $tag->slug]) }}"><i class="fa fa-close"></i></a></span>
                        @endforeach
                    </div>
                </div>
