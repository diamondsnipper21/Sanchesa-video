...
@section('content')
    ...
    <div class="container-fluid">
        <div class="pull-right">
            <a href="{{ route('admin.product_plans.create') }}" class="btn btn-primary">
                ...
                <table class="table table-bordered table-striped">
				    ...
				    @foreach ($plans as $index => $plan)
				        <tr>
				            ...
				            <td>
				                <a href="{{ route('admin.product_plans.edit', $plan->id) }}" class="btn btn-info">
				                	<i class="fa fa-pencil"></i>
				                </a>
			                    <a method="DELETE" href="{{ route('admin.product_plans.destroy', $plan->id) }}" data-confirm="Are you sure to delete?" class="btn btn-danger">
