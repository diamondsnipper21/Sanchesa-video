...
export default class Thumbnails extends React.Component {
    ...
    handleSelectedImage(image, e){
        ...
        Api.movies.add_image(this.state.movie_id, image.id)
        .then(res => res.json())
        .then(
            (result) => {
                this.setState({
    ...
    onImageRemove(image_id, e) {
        Api.movies.remove_image(this.state.movie_id, image_id)
        .then(res => res.json())
        .then(
            (result) => {
                this.setState({
    ...
    onUpdateFeaturedImage(image_id, e){
        Api.movies.update_featured_image(this.state.movie_id, image_id)
        .then(res => res.json())
        .then(
            (result) => {
                this.setState({
